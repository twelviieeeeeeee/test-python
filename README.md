...
Запуск(возможно не будет работать без бинарников,за полным репозиторием просьба писать мне в соц-сети которые указаны в резюме):
git clone https://github.com/twelviieeeeeeee/test-python.git
