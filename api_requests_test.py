...
def test_login_without_email():
    ApiClient().verify_login_without_email(password="somepassword123")


def test_verify_login_wrong_method():
    ApiClient().verify_login_wrong_method(email="gagaga", password="123123")


def test_verify_login_with_wrong_credentials():
    ApiClient().verify_login_with_wrong_credentials(email="gagaga", password="123123")
